...
export const translations: Record<Lang, Dict> = {
  ...
  ru: {
    ...
    hero: {
      ...
      subtitle:
        'В MediCor мы сочетаем современную диагностику с внимательным и спокойным подходом — чтобы вы понимали, что происходит с сердцем.',
      ctaContact: 'Контакты',
    ...
    services: {
      ...
      titleAccent: 'услуги',
      subtitle: 'Комплексная диагностика и лечение заболеваний сердца. Нажмите карточку, чтобы узнать больше.',
      learnMore: 'Подробнее →',
      close: 'Закрыть',
      items: [
        {
          ...
          description:
            'Спокойный разговор с кардиологом и первичный осмотр — понятный план действий без лишнего стресса.',
          icon: 'heart-pulse',
          details: [
            {
              heading: 'Что это за приём?',
              paragraphs: [
                'Это беседа со специалистом по сердцу и базовый осмотр. Особая подготовка не нужна — врач выслушает жалобы и поможет понять, что происходит с организмом.',
              ],
            },
            {
              heading: 'Как проходит визит?',
              list: [
                'Опрос: симптомы, образ жизни, лекарства и семейный анамнез.',
                'Просмотр имеющихся результатов анализов и ЭКГ.',
                'Осмотр: аускультация сердца и лёгких, измерение давления.',
                'План: наблюдение, дополнительные обследования или корректировка лечения.',
              ],
            },
            {
              heading: 'Что взять с собой?',
              paragraphs: ['Список лекарств и имеющуюся медицинскую документацию.'],
            },
          ],
        },
        {
          id: '2',
          title: 'Эхо сердца (ЭхоКГ)',
          description: 'УЗИ сердца — безболезненное исследование работы сердца и клапанов.',
          icon: 'waveform',
          details: [
            {
              heading: 'Что это за исследование?',
              paragraphs: [
                'Простыми словами — УЗИ сердца. Врач видит, как сердце сокращается, как качает кровь и как работают клапаны. Исследование безболезненное и безопасное.',
              ],
            },
            {
              heading: 'Как проходит исследование?',
              list: [
                'Нужно освободить верхнюю часть тела и лечь на кушетку (часто на левый бок).',
                'На грудную клетку наносится прохладный гель.',
                'Датчик УЗИ показывает сердце на мониторе.',
                'Обычно 15–20 минут; результат сразу на руки.',
              ],
            },
            {
              heading: 'Важно знать',
              paragraphs: ['Специальная подготовка не требуется.'],
            },
          ],
        },
        {
          ...
          description: 'ЭКГ при нагрузке — показывает, как сердце реагирует на физическую активность.',
          icon: 'activity',
          details: [
            {
              heading: 'Что это за исследование?',
              paragraphs: [
                'ЭКГ во время повышенной работы сердца. Некоторые проблемы проявляются только при нагрузке — тест оценивает реакцию кровообращения.',
              ],
            },
            {
              heading: 'Как проходит исследование?',
              list: [
                'Электроды ЭКГ на груди и манжета для давления на руке.',
                'Беговая дорожка или велоэргометр.',
                'Постепенное увеличение нагрузки под контролем персонала.',
                'Завершение при целевом пульсе или при усталости.',
              ],
            },
            {
              heading: 'Как подготовиться?',
              list: [
                'Удобная спортивная одежда и обувь на плоской подошве.',
                'Не есть плотно и не пить крепкий кофе/энергетики за 2 часа до исследования.',
              ],
            },
          ],
        },
        {
          id: '4',
          title: 'Холтер ЭКГ и АД',
          description: 'Портативный мониторинг сердца или давления в течение 24 часов.',
          icon: 'clock',
          details: [
            {
              heading: 'Что это за исследование?',
              paragraphs: [
                'Небольшой прибор, который носят 24 часа (или дольше), записывая работу сердца или давление в повседневной жизни и во сне.',
              ],
            },
            {
              heading: 'Как проходит исследование?',
              list: [
                'Установка прибора в кабинете (электроды или манжета).',
                'Обычные дела с дневником активности.',
                'Возврат прибора в клинику в назначенное время.',
              ],
            },
          ],
        },
    ...
    doctor: {
      ...
      subtitle: 'Опытная кардиологическая помощь. Нажмите карточку, чтобы узнать больше.',
      learnMore: 'Подробнее →',
      goContact: 'К контактам',
      close: 'Закрыть',
      name: 'лек. спец. Кшиштоф Врониш',
      specialty: 'Интернист 2 степени / Кардиология',
      bio: '30 лет профессионального опыта',
      details: [
        {
          heading: 'О враче',
          paragraphs: ['Подробный профиль появится в ближайшее время.'],
        },
        {
        ...
        },
        {
          heading: 'Опыт работы',
          paragraphs: [
            'Более 30 лет практики. Полное описание будет добавлено позже.',
          ],
        },
        {
    ...
    firstVisit: {
      ...
      subtitle: 'Мы готовим понятный гид для пациентов. Скоро он будет доступен.',
      badge: 'Скоро будет доступно',
      steps: [
        {
          title: '1. Связь и запись',
          text: 'Позвоните в клинику — поможем выбрать удобное время и подскажем, что взять с собой.',
        },
        {
          title: '2. Встреча с кардиологом',
          text: 'Спокойный разговор, опрос и первичный осмотр — без спешки, с понятными объяснениями.',
        },
        {
          title: '3. Дальнейшие шаги',
          text: 'Вы получите рекомендации: наблюдение, дополнительные обследования или лечение.',
        },
      ],
    },
    faq: {
      title: 'Частые',
      titleAccent: 'вопросы',
      subtitle: 'Раздел FAQ в разработке. Скоро здесь появятся ответы на важные вопросы.',
      badge: 'В разработке',
      items: [
        { q: 'Нужно ли направление?', a: 'Ответ появится в ближайшее время.' },
        { q: 'Как добраться до клиники?', a: 'Ответ появится в ближайшее время.' },
        { q: 'Как подготовиться к холтеру?', a: 'Ответ появится в ближайшее время.' },
      ],
    },
    contact: {
      title: 'Адрес и',
      titleAccent: 'контакты',
      subtitle: 'Ждём вас в центре Кентшина.',
